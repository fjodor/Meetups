...
* format: html
* format: docx
* Weitere: pdf, OpenOffice (odt), Powerpoint (pptx), epub, MediaWiki, Jupyter, InDesign, ...
...
### Quarto / R Markdown: R-Code und Text mischen
...
* Empfehlung: benennen; hier: *diamonds*; jeder Name muss eindeutig sein
* `message: false`: keine Hinweise ausgeben
* `echo: true`: Code im Dokument anzeigen
* p`eval: false`: Code nicht ausführen
